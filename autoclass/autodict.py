    ...
    * it overrides str and repr method if not already implemented
    ...
    if not super_is_already_a_mapping:
        if hasattr(object_type, '__len__'):
            warn('__len__ is already defined on this class, it will be overridden with the one generated by '
                 '@autodict/@autoclass !')
        if hasattr(object_type, '__iter__'):
            warn('__iter__ is already defined on this class, it will be overridden with the one generated by '
                 '@autodict/@autoclass !')
        if hasattr(object_type, '__getitem__'):
            warn('__getitem__ is already defined on this class, it will be overridden with the one generated by '
                 '@autodict/@autoclass !')
    # ELSE we will combine the generated methods with the super ones
